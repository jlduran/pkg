...
metalog_body()
{
	...
	echo "test123" > "${TMPDIR}/foo/bar.sh"
	echo "test123" > "${TMPDIR}/foo/bar/baz.sh"
	echo "test123" > "${TMPDIR}/foo/bar/baz/qux.sh"
...
EOF
	...
	./testdir3 type=dir uname=root gname=wheel mode=0750
	./testdir3/foo type=dir uname=root gname=wheel mode=0750
	./testdir3/foo/bar type=dir uname=root gname=wheel mode=0750
	./testdir3/foo/bar.sh type=file uname=root gname=wheel mode=0755
	./testdir3/foo/bar/baz type=dir uname=root gname=wheel mode=0750
